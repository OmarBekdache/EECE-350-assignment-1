...
echoMSG = ['echo message 1', 'echo message 2', 'echo message 3', 'echo message 4', 'echo message 5']
averageRTT = 0

for i in range (0,5):
    t1 = datetime.datetime.now()
    clientSocket.sendto(echoMSG[i].encode('utf-8'), (echoServerIP, echoServerPort))
